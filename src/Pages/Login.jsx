...
const Login = () => {
  ...
  return (
    <>
      <div className="flex h-screen absolute bg-white top-0 left-0 w-full lg:bg-gray-50 lg:gap-5 items-center">
        ...
        <section className="lg:w-2/3  w-full lg:p-4 sm:w-4/5 md:w-3/4 mx-auto lg:px-20 ">
          ...
          <div className="lg:p-10 p-5 bg-white rounded lg:shadow">
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* Forgot */}
              <div className=" px-3 mb-5 rounded flex justify-end items-center gap-3">
                <Link to="/forgot" className="font-medium">
